  ...
  return (
    ...
    <div class="grid max-w-[90%] px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto justify-center flex flex-col items-center place-self-center lg:col-span-7">
            <h1 class="py-10 mb-4 text-2xl  tracking-tight leading-none md:text-4xl text-center max-w-full lg:text-5xl font-semibold">International Conference on Computing, Networking, and Data Science</h1>
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/phone-mockup.webp" alt="mockup"></img>
        </div>                
    </div>
    </section>
  )
