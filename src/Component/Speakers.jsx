          ...
          {speakers.map((speaker, index) => (
            ...
            >
              ...
              <div className="p-6 ">
                ...
                <p className="text-xl md:text-base xl:text-xl text-indigo-700 mb-1 text-center">{speaker.institution}</p>
                <p className="text-purple-600 font-medium text-md md:text-sm xl:text-base text-center">{speaker.Location}</p>
              </div>
            </div>
          ))}
        </div>
